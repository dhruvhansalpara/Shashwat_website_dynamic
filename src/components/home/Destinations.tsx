            ...
            >
              <div className="relative h-full w-full">
                ...
                <div className="absolute right-6 top-6 z-20">
                  <div className="rounded-full bg-white/92 px-4 py-2 text-[11px] font-black uppercase tracking-widest text-gray-900 shadow-lg shadow-black/10 backdrop-blur-sm">
                    {destination.tourCount} Packages
                  </div>
                </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 transform translate-y-4 transition-transform duration-500 group-hover:translate-y-0">
                  <p className="text-brand-secondary font-black text-[10px] uppercase tracking-widest mb-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    {destination.tourCount} PREMIUM Tours
                  </p>

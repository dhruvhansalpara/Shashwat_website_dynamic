...
export default function Stats() {
  return (
    <section className="py-24 bg-[#FAFAFA]" id="stats">
      <div className="site-container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="w-16 h-16 bg-[#FDF2F7] rounded-2xl flex items-center justify-center mb-8 shadow-sm">
                <stat.icon className="w-8 h-8 text-brand-secondary transform group-hover:rotate-12 transition-transform" />
              </div>
              <h3 className="text-4xl lg:text-5xl font-display font-black text-[#05445E] mb-3 tracking-tighter">
                {stat.value}
              </h3>
